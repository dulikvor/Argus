...
{
    public class RestDiscoveryStep : State<ApiTestStateTransitions, ApiTestsStepInput, ApiTestsStepResult>
    {
        private IGitHubLLMQueryClient _gitHubLLMQueryClient;

        public RestDiscoveryStep(IGitHubLLMQueryClient gitHubLLMQueryClient, IPromptHandlerFactory promptHandlerFactory)
