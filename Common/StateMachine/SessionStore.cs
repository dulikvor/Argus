...
public static class SessionStore<TTransition, TStepInput, TStepResult>
    ...
    where TStepResult : StepResult
{
    ...
    public static Session<TTransition, TStepInput, TStepResult> GetSessions(string user) => Sessions.GetOrAdd(user, new Session<TTransition, TStepInput, TStepResult>());
}
